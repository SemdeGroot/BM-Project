...
plt.plot(doses, [value / dose_nfkb[0] for value in dose_nfkb], marker="o", linestyle="--", label="IL-6/NF-kb loop")
...
plt.title("T315 lowers ILK signaling and the IL-6/NF-kb loop")
...
axes[0].set_title("Early IL-6/NF-kb activation under hypoxia")
